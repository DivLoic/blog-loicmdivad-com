...
<button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="display:none;" bind:this={modal}></button>
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">💥 Error, sorry the sauces are unavailable.</h5>
                <button on:click={() => extra = false} type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>An unexpected error occurred: ${errorMessage}<p>
            </div>
            <div class="modal-footer">
                <button on:click={() => extra = false} type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
